                ...
                <div class="col-12">
                    <table class="table caption-top">
                        ...
                        <tr>
                            ...
                            <td>5000</td>
                            <td>
                                <div class="alert alert-primary" role="alert">Новый</div>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            ...
                            <td>2400</td>
                            <td>
                                <div class="alert alert-warning" role="alert">Обработка</div>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                        ...
                        <tr>
                            ...
                            <td>5000</td>
                            <td>
                                <div class="alert alert-danger" role="alert">Отмена</div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
